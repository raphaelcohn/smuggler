...
{
	#[inline(always)]
	fn parse<TP: TagParser<Tag=T>, TB: TiffBytes, Unit: Version6OrBigTiffUnit>(tag_parser: TP, allocator: A, tiff_bytes: &mut TB, byte_order: ByteOrder, image_file_directory_pointer: ImageFileDirectoryPointer) -> Result<(Self, Option<ImageFileDirectoryPointer>), ImageFileDirectoryParseError>
	{
		...
		let this = Self::parse_directory_entries::<TP, TB, Unit>(tag_parser, allocator, tiff_bytes, byte_order, directory_entries_index, number_of_directory_entries, number_of_directory_entry_bytes)?;
	...
	#[inline(always)]
	fn next_image_file_directory_pointer<TB: TiffBytes, Unit: Version6OrBigTiffUnit>(tiff_bytes: &TB, byte_order: ByteOrder, directory_entries_index: Index, number_of_directory_entry_bytes: NonZeroU64) -> Result<Option<ImageFileDirectoryPointer>, ImageFileDirectoryParseError>
	{
	...
	fn parse_directory_entries<TP: TagParser<Tag=T>, TB: TiffBytes, Unit: Version6OrBigTiffUnit>(tag_parser: TP, allocator: A, tiff_bytes: &'a mut TB, byte_order: ByteOrder, directory_entries_index: Index, number_of_directory_entries: NonZeroU64, number_of_directory_entry_bytes: NonZeroU64) -> Result<Self, ImageFileDirectoryParseError>
	{
		...
		loop
		{
			let tag = Self::parse_directory_entry_unchecked::<TP, TB, Unit>(tag_parser, allocator, tiff_bytes, byte_order, directory_entry_index, &mut previous_tag_identifier)?;
	...
	#[inline(always)]
	fn parse_directory_entry_unchecked<TP: TagParser<Tag=T>, TB: TiffBytes, Unit: Version6OrBigTiffUnit>(tag_parser: TP, allocator: A, tiff_bytes: &'a mut TB, byte_order: ByteOrder, directory_entry_index: Index, previous_tag_identifier: &mut Option<u16>) -> Result<DirectoryEntry<'a, A>, TagParseError>
	{
		...
		tag_parser.parse::<A, Unit, TB>(allocator, tiff_bytes, tag_identifier, tag_type, count, byte_order, offset_or_value_union_index)
	}
