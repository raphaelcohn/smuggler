...
pub(in crate::tiff::image_file_directory) trait Version6OrBigTiffUnit: Into<u64>
{
	...
	fn long8_offset_or_value<B: Bytes>(tiff_bytes: &B, offset_or_value_union_index: u64, byte_order: ByteOrder) -> Result<u64, SpecificTagParseError>;
	
	fn slong8_offset_or_value<B: Bytes>(tiff_bytes: &B, offset_or_value_union_index: u64, byte_order: ByteOrder) -> Result<i64, SpecificTagParseError>;
}
...
impl Version6OrBigTiffUnit for u32
{
	...
	fn number_of_directory_entries<B: Bytes>(tiff_bytes: &B, index: u64, byte_order: ByteOrder) -> Result<Self::NumberOfDirectoryEntries, OverflowError>
	{
		tiff_bytes.unaligned_u16(index, byte_order)
	}
	
	#[inline(always)]
	fn offset_like_value<B: Bytes>(tiff_bytes: &B, index: u64, byte_order: ByteOrder) -> Result<Self::OffsetLikeValue, OverflowError>
	{
		tiff_bytes.unaligned_u32(index, byte_order)
	}
	
	#[inline(always)]
	fn offset_like_value_unchecked<B: Bytes>(tiff_bytes: &B, index: u64, byte_order: ByteOrder) -> Self::OffsetLikeValue
	{
		tiff_bytes.unaligned_u32_unchecked(index, byte_order)
	}
	...
	fn long8_offset_or_value<B: Bytes>(tiff_bytes: &B, offset_or_value_union_index: u64, byte_order: ByteOrder) -> Result<u64, SpecificTagParseError>
	{
		...
		tiff_bytes.unaligned_u64(index, byte_order).map_err(Long8Overflow)
	}
	...
	fn slong8_offset_or_value<B: Bytes>(tiff_bytes: &B, offset_or_value_union_index: u64, byte_order: ByteOrder) -> Result<i64, SpecificTagParseError>
	{
		...
		let index = offset.u64();
		tiff_bytes.unaligned_i64(index, byte_order).map_err(Slong8Overflow)
	}
}
...
impl Version6OrBigTiffUnit for u64
{
	...
	fn number_of_directory_entries<B: Bytes>(tiff_bytes: &B, index: u64, byte_order: ByteOrder) -> Result<Self::NumberOfDirectoryEntries, OverflowError>
	{
		tiff_bytes.unaligned_u64(index, byte_order)
	}
	...
	fn offset_like_value_unchecked<B: Bytes>(tiff_bytes: &B, index: u64, byte_order: ByteOrder) -> Self::OffsetLikeValue
	{
		tiff_bytes.unaligned_u64_unchecked(index, byte_order)
	}
	...
	{
		Ok(tiff_bytes.unaligned_u64_unchecked(offset_or_value_union_index, byte_order))
	}
	
	#[inline(always)]
	fn slong8_offset_or_value<B: Bytes>(tiff_bytes: &B, offset_or_value_union_index: u64, byte_order: ByteOrder) -> Result<i64, TagParseError>
	{
		Ok(tiff_bytes.unaligned_i64_unchecked(offset_or_value_union_index, byte_order))
	}
}
