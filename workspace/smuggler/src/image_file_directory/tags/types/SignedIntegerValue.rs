...
impl SignedIntegerValue
{
	...
	#[inline(always)]
	pub(in crate::image_file_directory::tags) fn parse_offset_or_value(tag_type: TagType, slice: NonNull<[u8]>, byte_order: ByteOrder) -> Result<Self, SpecificTagParseError>
	{
		use TagType::*;
		use SignedIntegerValue::*;
